...
const WA_URL =
  "https://api.whatsapp.com/message/5QLGPVKNZKX3B1?autoload=1&app_absent=0&utm_source=ig";
...
function FloatingNav({ onCTA }: { onCTA: () => void }) {
  ...
  return (
    <nav
      className={`fixed top-3 left-0 right-0 z-50 flex justify-between items-center px-4 sm:px-8 py-3 mx-3 sm:mx-8 rounded-2xl transition-all duration-500 ${
        scrolled
          ? "bg-black/90 backdrop-blur-xl border border-white/8 shadow-2xl"
          : "bg-transparent"
      }`}
    >
      <span
        className="text-white font-bold text-sm sm:text-base tracking-widest uppercase"
        style={{ color: GOLD }}
      >
        Studio Markin
      </span>
              ...
              {sent ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-white/60 text-sm mb-6">
                    Entraremos em contato no seu número. Aguarde!
                  </p>
                  <button
                    onClick={onClose}
                    className="px-8 py-2.5 rounded-full font-bold text-black text-sm"
                    style={{
                      background: `linear-gradient(135deg, ${GOLD}, ${GOLD_LIGHT})`,
                    }}
                  >
                ...
                <>
                  <div className="mb-6">
                    ...
                    <p className="text-sm" style={{ color: GOLD }}>
                      Curso de Tatuagem Prática – Studio Markin
                    </p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="basica">
                          Básica – já pratiquei um pouco
                        </option>
                        <option value="intermediaria">
                          Intermediária – já tatuo informalmente
                        </option>
                        <option value="avancada">
                          Avançada – quero aperfeiçoar
                        </option>
                      </select>
                    </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(0,0,0,0.88) 0%, rgba(0,0,0,0.6) 50%, rgba(0,0,0,0.25) 100%)",
            }}
          />
          <div
            className="absolute inset-0"
            style={{
              background:
                "linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, transparent 40%, rgba(0,0,0,0.98) 100%)",
            }}
          />
        </motion.div>
          ...
          >
            {!logoFailed ? (
              ...
              <div>
                ...
                <h1 className="text-4xl sm:text-6xl font-black uppercase leading-none text-white">
                  TATUAGEM PRÁTICA
                </h1>
                <p
          ...
          >
            {!tituloFailed ? (
              ...
              <p className="text-3xl sm:text-5xl font-black uppercase tracking-wide text-white leading-tight">
                CURSO PRESENCIAL
                <br />
                COM AULAS <span style={{ color: GOLD }}>PRÁTICAS</span>
                <br />E TEÓRICAS
              </p>
            )}
          </motion.div>
      ...
      >
        ...
        >
          ...
          <motion.h2
            variants={fadeUp}
            className="text-3xl sm:text-5xl md:text-6xl font-bold text-white mb-8"
          >
          ...
          <motion.p
            variants={fadeUp}
            className="text-base sm:text-lg md:text-xl text-white/75 leading-relaxed max-w-3xl mx-auto"
          >
            Nosso curso presencial tem como propósito{" "}
            <strong className="text-white">formar novos profissionais</strong> e
            impulsionar sua carreira na tatuagem de maneira ágil, segura e
            altamente eficaz. Com uma didática prática e acessível, o
            treinamento habilita o estudante a iniciar sua trajetória no mercado
            da tatuagem <strong className="text-white">do zero</strong>.
          </motion.p>
        </motion.div>
      </Section>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <p className="text-white/40 text-xs text-center px-4">
                  Adicione a foto do Markin
                  <br />
                  em /public/media/markin-foto.jpg
                </p>
              </div>
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">
                Quem é o <br />
                <span style={{ color: GOLD }}>Marcos Santos?</span>
              </h2>
              <div className="space-y-4 text-white/70 text-sm sm:text-base leading-relaxed">
                <p>
                  <strong className="text-white">Marcos Santos</strong> atua a
                  mais de 10 anos, destaca-se fortemente no{" "}
                  <strong className="text-white">
                    Realismo Preto e Cinza (Black & Grey)
                  </strong>
                  , retratando com alta precisão rostos, figuras mitológicas,
                  guerreiros, animais e imagens religiosas.
                </p>
                <p>
                  Já estudou com os maiores nomes do mundo da tatuagem nacional,
                  fez diversos cursos sobre técnicas de tatuagem, além de cursos
                  voltados para artes como desenho e pintura.
                </p>
                <p>
                  Já participou de muitos eventos de tatuagem do país e possui
                  diversos prêmios na sua área.{" "}
                  <strong className="text-white">
                    Ministra cursos e mentoria particulares desde 2022.
                  </strong>
                </p>
                <p>
                  CEO de um estúdio privativo localizado na Rodovia Governador
                  Mário Covas, 1990, São Geraldo, Serra – ES.
                </p>
              </div>
              <button
                onClick={openModal}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.h2
              ...
              className="text-3xl sm:text-5xl md:text-6xl font-bold text-white"
            >
              Nosso <span style={{ color: GOLD }}>cronograma</span>
            </motion.h2>
          </motion.div>
          <motion.div
            variants={fadeRight}
          ...
          >
            {[
              ...
              {
                title:
                  "Fundamentos / Biossegurança / Equipamentos / Estilos de tattoo / Tráfego pago.",
                classes: [
                  {
                    count: "1",
                    type: "Fundamentos",
                    title: "História da tatuagem e legislação para tatuadores.",
                    subtitle: "Teoria",
                  },
                  {
                    count: "2",
                    type: "Fundamentos",
                    title: "Histologia da pele, cuidados  e cicatrização.",
                    subtitle: "Teoria",
                  },
                  {
                    count: "3",
                    type: "Biossegurança",
                    title:
                      "contaminação cruzada, EPIs, materiais de higiene, esterilização, higiene na área de trabalho.",
                    subtitle: "Teoria",
                  },
                  {
                    count: "4",
                    type: "Equipamentos e Materiais",
                    title:
                      "Máquinas (bobina, rotativa, PEN), Agulhas (haste x cartucho), Tintas e a fins.",
                    subtitle: "Teoria",
                  },
                  {
                    count: "5",
                    type: "Estilos de tattoo e Tráfego pago",
                    title:
                      "Estilos de Tatuagem e tráfego pago para tatuadores.",
                    subtitle: "Teoria",
                  },
                ],
              },
              ...
              {
                title:
                  "Técnicas de Traços / Sombreamento / Degrade / simetria.",
                classes: [
                  {
                    count: "6",
                    type: "Preparação",
                    title:
                      "Transferência de decalque para  pele sintética, preparação da bancada e da área de trabalho.",
                    subtitle: "Prática + Demonstração",
                  },
                  {
                    count: "7",
                    type: "Técnicas de Traços",
                    title:
                      "Como fazer traço fino e grosso. Exercícios de traços em pele sintética.",
                    subtitle: "Prática + Demonstração",
                  },
                  {
                    count: "8",
                    type: "Técnicas de Sombreamento",
                    title:
                      "Projeção de Luz e sombra. Exercícios de sombreamento em pele sintética.",
                    subtitle: "Prática + Demonstração",
                  },
                  {
                    count: "9",
                    type: "Preenchimento e Degradê",
                    title:
                      "Escala de sobra. Exercícios de preenchimento e degradê em pele sintética.",
                    subtitle: "Prática + Demonstração",
                  },
                  {
                    count: "10",
                    type: "Preenchimento e Degradê",
                    title:
                      "Exercícios de simetria. Mini-projeto com traço + sombra + preenchimento.",
                    subtitle: "Prática + Demonstração",
                  },
                ],
              },
              ...
              {
                title: "Simulação de Atendimento / Exercícios práticos.",
                classes: [
                  {
                    count: "11",
                    type: "Atendimento",
                    title:
                      "Simulação de atendimento e criação de desenho autoral ou personalizado.",
                    subtitle: "Prática",
                  },
                  {
                    count: "12",
                  ...
                  {
                    count: "13",
                    type: "Exercícios de Tatuagem",
                    title: "Aplicação de estilo escolhido em pele sintética.",
                    subtitle: "Prática",
                  },
                  {
                    count: "14",
              ...
              {
                title:
                  "Gestão e Carreira / Prática Supervisionada / Encerramento",
                classes: [
                  {
                    count: "16",
                    type: "Gestão e Carreira",
                    title: "Precificação da Tattoo e montagem de portfólio.",
                    subtitle: "Network",
                  },
                  {
                    count: "17",
                    type: "Prática Supervisionada",
                    title:
                      "Tatuagem em pele sintética ou modelo humano supervisionada.",
                    subtitle: "Prática",
                  },
                  {
                    count: "18",
                  ...
                  },
                  {
                    ...
                    type: "Encerramento",
                    title:
                      "Feedback, avaliação final e entrega de certificado.",
                    subtitle: "Network",
                  },
                ],
              },
              ...
              <div>
                <motion.div
                  onClick={() =>
                    document
                      .getElementById(`dropdown-example-${i}`)
                  ...
                  className={`flex gap-4 items-start p-4 rounded-xl border hover:border-[#C9A84C] cursor-pointer`}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white/45 text-sm mt-0.5">{item.title}</p>
                  </div>
                </motion.div>

                <motion.ul
                  id={`dropdown-example-${i}`}
                ...
                >
                  {item.classes.map((item) => (
                    <li>
                      <div className="ml-12 pl-4 mr-12 pb-2 border-b">
                        <div className="mb-2">
                          <p
          ...
          >
            OBS: O studio disponibiliza os materiais necessários para prática
            dos exercícios.
          </motion.p>
        </div>
      </Section>
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={inViewOpts}
            className="grid grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8"
          >
            {[
              {
                icon: <TrendingUp className="h-8 w-8" />,
                label: "Evolução rápida e descomplicada",
              },
              {
                icon: <Headphones className="h-8 w-8" />,
                label: "Suporte especial para os alunos",
              },
              {
                icon: <BookOpen className="h-8 w-8" />,
                label: "Apostilas autoexplicativas",
              },
              {
                icon: <Wrench className="h-10 w-10" />,
                label: "Materiais necessários para prática sem custo extra",
              },
              {
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/70 text-sm sm:text-base leading-relaxed mb-4">
              Se você busca se destacar no mercado da tatuagem, esta é a sua
              oportunidade. O tatuador Marcos Santos ministrará um curso
              presencial exclusivo na cidade de Serra (ES), compartilhando as
              técnicas avançadas que utiliza para alcançar uma pigmentação
              impecável e resultados de alto impacto.
            </p>
            <p className="text-white/70 text-sm sm:text-base leading-relaxed">
              Com uma metodologia que vai do nível iniciante ao avançado, o
              treinamento une uma base teórica sólida a uma intensa carga
              horária prática. Todo o aprendizado prático será realizado
              inicialmente em pele artificial, garantindo que o aluno desenvolva
              a coordenação e a confiança necessárias para a profissão.
            </p>
          </motion.div>
          ...
          >
            {[
              {
                text: "Método validado por centenas de alunos",
                detail: "Técnicas aprovadas em mais de 10 anos de prática",
              },
              {
                text: "Prática real em pele artificial",
                detail: "Do primeiro traço até a tatuagem completa",
              },
              {
                text: "Suporte pós-curso pelo professor",
                detail: "Marcos está sempre disponível para dúvidas",
              },
              {
                text: "Certificado de conclusão reconhecido",
                detail: "Comprove sua formação para clientes e estúdios",
              },
              {
                text: "Materiais fornecidos pelo studio",
                detail: "Sem custo extra para praticar durante o curso",
              },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            >
              ...
              <p className="text-2xl sm:text-2xl font-black text-white/60  mb-2 line-through">
                R$ <span>5.000,00</span>
              </p>
              <p className="text-5xl sm:text-7xl font-black text-white mb-2">
                R$ <span style={{ color: GOLD }}>3.500</span>
                <span className="text-3xl sm:text-5xl">,00</span>
              </p>

              <div
                className="my-6 h-px w-32 mx-auto"
                style={{
              ...
              <p className="text-xl sm:text-2xl font-bold text-white mb-1">
                R$ 3.995,44 em <span style={{ color: GOLD }}>12X</span> no
                cartão
              </p>
              <p className="text-white/40 text-xs">(12 × R$ 332,95)</p>
              ...
              <div className="flex items-center gap-2">
                {TESTIMONIALS.map((_, i) => (
                  <button
                    ...
                    style={{
                      background: i === testimonialIdx ? GOLD : `${GOLD}30`,
                      transform:
                        i === testimonialIdx ? "scale(1.4)" : "scale(1)",
                    }}
                  />
                ))}
              </div>
      ...
      <Section
        id="matricula"
        className="py-20 md:py-28"
        style={{ background: "#000" } as React.CSSProperties}
      >
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/55 text-base mb-8">
              E alcance a sua independência financeira.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 text-white/70 text-sm">
                ...
                />
                <div>
                  <p className="font-semibold text-white text-xs uppercase tracking-wider mb-0.5">
                    Endereço
                  </p>
                  <p>{ADDRESS}</p>
                </div>
          ...
          >
            <img
              ...
              style={{
                maxHeight: "clamp(180px, 30vw, 340px)",
      ...
      >
        <p className="text-white/25 text-xs">
          © {new Date().getFullYear()} Studio Markin Tattoo — Serra, ES. Todos
