        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {itemsToShow.map((item, index) => {
            ...
            const wrapperClasses = isHero
              ? 'group relative overflow-hidden rounded-lg shadow-lg bg-neutral-800 lg:col-span-2 lg:row-span-2'
              : 'group relative overflow-hidden rounded-lg shadow-lg bg-neutral-800';
            ...
            return (
              ...
              >
                <div className={isHero ? 'aspect-[4/3] overflow-hidden' : 'aspect-square overflow-hidden'}>
                  <ImageWithFallback
                    src={item.image}
                    alt={item.title}
                ...
                >
                  <h3 className="text-neutral-100 text-lg font-bold mb-1">{item.title}</h3>
